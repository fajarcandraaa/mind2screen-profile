    ...
    <div className="hero">
        <div className="wrapper">
            <div className="textContainer">
                <motion.img className='logoStroke' src={`${import.meta.env.BASE_URL}/mind2screen/logo_stroke-2.png`} initial={{ opacity: 0, pathLength: 0 }} animate={{ opacity: 1, pathLength: 1 }} transition={{ duration: 0.5, delay: 0.25 }} alt=""/>
                <h1>
                {text.map((el, i) => (
                    <motion.span
                    initial={{ opacity: 0 }}
        ...
        <div className="imageContainer">
            <div className="image-stack">
                <motion.img
                className="image"
                src={`${import.meta.env.BASE_URL}/mind2screen/mind2screen_bg2.png`}
                style={{ zIndex: 1 }}
                variants={container}
                initial="hidden"
                ...
                <motion.img
                className="image"
                src={`${import.meta.env.BASE_URL}/mind2screen/mind2screen_char2.png`}
                style={{ zIndex: 2 }}
                alt=""
                />
            </div>
